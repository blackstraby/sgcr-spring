...
function limparImportarPercurso(){
    //Limpa campos de importar percurso
...
function confimarSalvarCorrida(){
    ...
    var numeroPessoas = document.getElementById("maxPessoa").value.length;
    var DtCorrida = document.getElementById("data").value.length;
